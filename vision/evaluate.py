...
def evaluate(model, loss_fn, dataloader, metrics, params):
    ...
    Args:
        ...
        dataloader: (DataLoader) a megengine.utils.data.DataLoader object that fetches data
    ...
    for data_batch, labels_batch in dataloader:
        ...
        data_batch, labels_batch = megengine.Tensor(
            data_batch), megengine.Tensor(labels_batch)
...
if __name__ == '__main__':
    ...
    params.cuda = megengine.is_cuda_available()  # use GPU is available
